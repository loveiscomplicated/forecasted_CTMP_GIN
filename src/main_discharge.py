...
from src.trainers.run_discharge_prediction import run_discharge_prediction
...
def parse_args():
    p = argparse.ArgumentParser(description="Train multi-task discharge predictor")
...
def main():
    ...
    run_discharge_prediction(cfg, root)
